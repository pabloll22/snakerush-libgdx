...
public class nivel6 implements Screen {
    ...
    public nivel6() {
        ...
        try {
          	 ...
          	 String consulta = "SELECT nombre_usuario,record FROM Jugador where rownum<4 Order by record DESC";
          	 String consulta2 = "SELECT nombre_usuario, record FROM (SELECT nombre_usuario, record FROM Jugador ORDER BY record DESC) WHERE ROWNUM <= 3";
